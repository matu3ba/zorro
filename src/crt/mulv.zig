...
//   * target must be able to represent result in register
...
// TODO benchmark, if approximation is more useful than simpler division approach for embedded
// TODO also measure used binary space for embedded

// assume
// 1. CPUs with higher integer range have intrinsics,
// 2. target architectures can not or does not want tot use bigger number ranges
...
// TODO comptime logic to ensure selection is actually fast
// (register size available on target)
